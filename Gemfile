...
gem "carrierwave", "~> 2.1", ">= 2.1.0" # Upload files in your Ruby applications, map them to a range of ORMs, store them on different backends
...
gem "omniauth", "~> 1.9", ">= 1.9.1" # A generalized Rack framework for multiple-provider authentication
...
gem "rails", "~> 6.1", ">= 6.1.7.1" # Ruby on Rails
...
gem "sprockets", "~> 4.0", ">= 4.0.0" # Sprockets is a Rack-based asset packaging system
...
group :development do
  gem "better_errors", "~> 2.7", ">= 2.7.0" # Provides a better error page for Rails and other Rack apps
