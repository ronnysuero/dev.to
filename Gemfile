...
gem "nokogiri", "~> 1.18", ">= 1.18.3" # HTML, XML, SAX, and Reader parser
...
group :development, :test do
  ...
  gem "rubocop-performance", "~> 1.24", ">= 1.24.0", require: false # A collection of RuboCop cops to check for performance optimizations in Ruby code
  gem "rubocop-rails", "~> 2.30", ">= 2.30.0", require: false # Automatic Rails code style checking tool
  gem "rubocop-rspec", "~> 3.5", ">= 3.5.0", require: false # Code style checking for RSpec files
