...
gem "activerecord-import", "~> 1.0", ">= 1.0.5" # Adds ability to bulk create activerecord objects
...
gem "blazer", "~> 2.2.3" # Allows admins to query data
...
gem "counter_culture", "~> 2.4", ">= 2.4.0" # counter_culture provides turbo-charged counter caches that are kept up-to-date
...
gem "doorkeeper", "~> 5.3", ">= 5.3.3" # Oauth 2 provider
gem "dry-struct", "~> 1.2" # Typed structs and value objects
gem "elasticsearch", "~> 7.6" # Powers DEVs core search functionality
gem "email_validator", "~> 2.1", ">= 2.1.0" # Email validator for Rails and ActiveModel
...
gem "feedjira", "~> 3.1", ">= 3.1.2" # A feed fetching and parsing library
...
gem "fog-aws", "~> 3.6", ">= 3.6.4" # 'fog' gem to support Amazon Web Services
...
gem "jbuilder", "~> 2.10", ">= 2.10.1" # Create JSON structures via a Builder-style DSL
...
gem "octokit", "~> 4.19", ">= 4.19.0" # Simple wrapper for the GitHub API
...
gem "pundit", "~> 2.1", ">= 2.1.1" # Object oriented authorization for Rails applications
...
gem "ransack", "~> 2.4", ">= 2.4.0" # Searching and sorting
...
gem "reverse_markdown", "~> 2.1", ">= 2.1.1" # Map simple html back into markdown
...
gem "strong_migrations", "~> 0.6", ">= 0.6.5" # Catch unsafe migrations
gem "timber", "~> 3.0" # Great Ruby logging made easy
gem "timber-rails", "~> 1.0" #  Timber integration for Rails
gem "twilio-ruby", "~> 5.34", ">= 5.34.1" # The official library for communicating with the Twilio REST API
gem "twitter", "~> 7.0" # A Ruby interface to the Twitter API
gem "uglifier", "~> 4.2" # Uglifier minifies JavaScript files
gem "ulid", "~> 1.2" # Universally Unique Lexicographically Sortable Identifier implementation for Ruby
gem "validate_url", "~> 1.0", ">= 1.0.10" # Library for validating urls in Rails
gem "webpacker", "~> 5.2.0" # Use webpack to manage app-like JavaScript modules in Rails

group :development do
  gem "better_errors", "~> 2.7", ">= 2.7.1" # Provides a better error page for Rails and other Rack apps
  ...
  gem "derailed_benchmarks", "~> 1.8", ">= 1.8.0", require: false # A series of things you can use to benchmark a Rails or Ruby app
  gem "erb_lint", "~> 0.0.33", require: false # ERB Linter tool
  gem "fix-db-schema-conflicts", "~> 3.1", ">= 3.1.0" # Ensures consistent output of db/schema.rb despite local differences in the database
  ...
  gem "yard-activerecord", "~> 0.0.17" # YARD extension that handles and interprets methods used when developing applications with ActiveRecord
...
group :development, :test do
  ...
  gem "bullet", "~> 6.1", ">= 6.1.1" # help to kill N+1 queries and unused eager loading
  ...
  gem "rubocop-rails", "~> 2.6", ">= 2.6.0", require: false # Automatic Rails code style checking tool
...
group :test do
  gem "approvals", "~> 0.0", ">= 0.0.25" # A library to make it easier to do golden-master style testing in Ruby
  ...
  gem "shoulda-matchers", "~> 4.4.0", require: false # Simple one-liner tests for common Rails functionality
  ...
  gem "webdrivers", "~> 4.4", ">= 4.4.0" # Run Selenium tests more easily with install and updates for all supported webdrivers
  gem "webmock", "~> 3.8" # WebMock allows stubbing HTTP requests and setting expectations on HTTP requests
  gem "zonebie", "~> 0.6.1" # Runs your tests in a random timezone
end

group :doc do
  gem "sdoc", "~> 2.0", ">= 2.0.0" # rdoc generator html with javascript search index
end
