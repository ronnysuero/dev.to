...
gem "administrate", "~> 0.14", ">= 0.14.0" # A Rails engine that helps you put together a super-flexible admin dashboard
...
gem "carrierwave", "~> 2.2", ">= 2.2.6" # Upload files in your Ruby applications, map them to a range of ORMs, store them on different backends
...
gem "nokogiri", "~> 1.15", ">= 1.15.6" # HTML, XML, SAX, and Reader parser
gem "octokit", "~> 4.16" # Simple wrapper for the GitHub API
gem "oj", "~> 3.10" # JSON parser and object serializer
gem "omniauth", "~> 1.9", ">= 1.9.2" # A generalized Rack framework for multiple-provider authentication
...
gem "rails", "~> 7.0", ">= 7.0.8.1" # Ruby on Rails
gem "rails-settings-cached", ">= 2.2.0" # Settings plugin for Rails that makes managing a table of global key, value pairs easy.
...
gem "sprockets", "~> 4.0", ">= 4.0.1" # Sprockets is a Rack-based asset packaging system
...
group :development do
  ...
  gem "yard", "~> 0.9.35" # YARD is a documentation generation tool for the Ruby programming language
