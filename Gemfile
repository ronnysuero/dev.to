...
gem "envied", "~> 0.10", ">= 0.10.0" # Ensure presence and type of your app's ENV-variables
...
gem "figaro", "~> 1.2", ">= 1.2.0" # Simple, Heroku-friendly Rails app configuration using ENV and a single YAML file
...
gem "nokogiri", "~> 1.18", ">= 1.18.9" # HTML, XML, SAX, and Reader parser
...
gem "rails", "~> 5.2", ">= 5.2.4.3" # Ruby on Rails
...
group :development do
  ...
  gem "bundler-audit", "~> 0.7", ">= 0.7.0" # bundler-audit provides patch-level verification for Bundled apps
  ...
  gem "guard", "~> 2.17", ">= 2.17.0", require: false # Guard is a command line tool to easily handle events on file system modifications
